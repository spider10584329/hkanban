    ...
    const handleLoginClick = async (e: React.MouseEvent<HTMLButtonElement>) => {
        ...
        try {
            ...
            if (data.token) {
                ...
                // Store Minew storeId if available
                if (data.minewStoreId) {
                    localStorage.setItem('minewStoreId', data.minewStoreId);
                    console.log('Stored Minew storeId:', data.minewStoreId);
                }
                                        ...
                                        <div className="flex justify-center">
                                            <div className="inline-flex items-center gap-2 bg-gray-100 rounded-full p-1">
                                                <button
                                                    ...
                                                    className={`px-4 py-1.5 rounded-full text-xs font-semibold transition-all duration-200 ${userRole === 'admin'
                                                ...
                                                <button
                                                    ...
                                                    className={`px-4 py-1.5 rounded-full text-xs font-semibold transition-all duration-200 ${userRole === 'agent'
                                                            ? 'bg-gray-900 text-white shadow-sm'
                                                            : 'bg-transparent text-gray-600 hover:text-gray-900'
                                                        }`}
                                                >
